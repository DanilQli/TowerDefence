...
func choose_turret(id):
	if number_card_choose_characters_choose_item != id:
		...
		get_node("VBoxContainer/Panel/VBoxContainer/Armanent/Vbox/Panel/HBoxContainer/Title1/AnimationPlayer").play("rotate")
		get_node("VBoxContainer/Panel/VBoxContainer/Armanent/Vbox/Panel/HBoxContainer/Title2/AnimationPlayer").play("rotate")
		get_node("VBoxContainer/Panel/VBoxContainer/Armanent/Vbox/Panel/HBoxContainer/Title3/AnimationPlayer").play("rotate")
		get_node("VBoxContainer/Panel/VBoxContainer/Armanent/Vbox/Panel/HBoxContainer/Title4/AnimationPlayer").play("rotate")
		...
		get_node("VBoxContainer/Panel/VBoxContainer/Armanent/Vbox/Panel/HBoxContainer/Title1/AnimationPlayer").stop()
		get_node("VBoxContainer/Panel/VBoxContainer/Armanent/Vbox/Panel/HBoxContainer/Title2/AnimationPlayer").stop()
		get_node("VBoxContainer/Panel/VBoxContainer/Armanent/Vbox/Panel/HBoxContainer/Title3/AnimationPlayer").stop()
		get_node("VBoxContainer/Panel/VBoxContainer/Armanent/Vbox/Panel/HBoxContainer/Title4/AnimationPlayer").stop()
...
func choose_characters_choose_item(id):
	...
	get_node("VBoxContainer/Panel/VBoxContainer/Armanent/Vbox/Panel/HBoxContainer/Title3/AnimationPlayer").stop()
	get_node("VBoxContainer/Panel/VBoxContainer/Armanent/Vbox/Panel/HBoxContainer/Title4/AnimationPlayer").stop()
	GameData.tower_data["Turret_" + str(list_button_activity[id] + 1) + "T1"]["activity"] = false
	GameData.tower_data["Turret_" + str(number_card_choose_characters_choose_item + 1) + "T1"]["activity"] = true
	GameData.config.set_value("Turret_" + str(list_button_activity[id] + 1) + "T1", "activity", false)
	GameData.config.set_value("Turret_" + str(number_card_choose_characters_choose_item + 1) + "T1", "activity", true)
	GameData.menu_object.queue_free()
	GameData.menu_object = load("res://Scenes/SupportScenes/shop.tscn").instantiate()
	get_parent().get_node(".").add_child(GameData.menu_object)
	GameData.write_file()
